...
def PNet():
  ...
  #pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
  #conv4 = Conv2D(256, (16, 1), activation='relu', padding='same')(conv3)
  #pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
  f1 = Flatten()(conv2)
  fc1 = Dense(2048, activation='linear')(f1)
  fc2 = Dense(4096, activation='linear')(fc1)
  fc3 = Dense(8192, activation='linear')(fc2)
  #fc4 = Dense(1024, activation='linear')(fc3)
  period = Dense(1, activation='linear')(fc3)
  ...
  model.compile(optimizer=Adam(lr=1e-5), loss='mae', metrics=['mse', 'mae'])
